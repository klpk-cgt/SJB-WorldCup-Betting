...
export type FunFactCategory = 'trophy' | 'rules' | 'quirky' | 'records' | 'culture';
...
export const FUN_FACT_CATEGORY_META: Record<FunFactCategory, { label: string; icon: string }> = {
  trophy: { label: '奖杯故事', icon: '🏆' },
  rules: { label: '规则演变', icon: '📋' },
  quirky: { label: '奇人异事', icon: '🎭' },
  records: { label: '数据之最', icon: '📊' },
  culture: { label: '文化趣闻', icon: '🌍' },
};

export const FUN_FACTS: FunFactItem[] = [
  // ═══ 奖杯故事 (6条) ═══
  { title: '奖杯曾失窃', fact: '1966年世界杯前，雷米特杯在伦敦展览时被盗，一只名叫Pickles的牧羊犬在灌木丛中找到了它。', icon: '🐕', category: 'trophy' },
  { title: '雷米特杯被永久保留', fact: '1970年巴西第三次夺冠后，雷米特杯被永久授予巴西。但1983年它在里约热内卢再次被盗，至今下落不明，据说已被熔化。', icon: '🏆', category: 'trophy' },
  { title: '大力神杯的底座快写满了', fact: '大力神杯底座可刻17届冠军名字，从1974年到2022年已刻了13届，还剩4届空间。2038年后可能需要加高底座或更换奖杯。', icon: '📝', category: 'trophy' },
  { title: '奖杯不是纯金的', fact: '大力神杯高36.8厘米、重6.175公斤，由18K黄金铸造，但并非纯金——纯金太软且太重。内部为实心，价值约20万美元，但它的象征意义远超金钱。', icon: '✨', category: 'trophy' },
  { title: '冠军只拿复制品', fact: '夺冠球队只能在庆典上捧起真杯，赛后必须归还。国际足联会颁发一座镀铜复制品给冠军永久保留，真杯始终由国际足联保管。', icon: '🎭', category: 'trophy' },
  { title: '奖杯有专属保险箱', fact: '大力神杯不使用时被锁在国际足联苏黎世总部的秘密保险箱中。每次出场都有严密安保，运输时配备专属护卫团队。', icon: '🔒', category: 'trophy' },

  // ═══ 规则演变 (6条) ═══
  { title: '金球制胜', fact: '1998年法国世界杯首次使用"金球制"（突然死亡法），布兰科打入世界杯史上第一个金球。2002年后金球制被废除，2006年起改为加时赛30分钟完整打完。', icon: '⚡', category: 'rules' },
  { title: '换人规则的大变革', fact: '1970年世界杯才首次允许换人，每场只能换2人。2022年世界杯首次允许加时赛额外换1人（共5+1），2026年将继续沿用5人换人制。', icon: '🔄', category: 'rules' },
  { title: 'VAR改变世界杯', fact: '2018年世界杯首次全面使用VAR视频助理裁判，共改变20个关键判罚。法国对澳大利亚的比赛中，世界杯历史上第一个VAR点球诞生。', icon: '📺', category: 'rules' },
  { title: '红黄牌的诞生', fact: '1970年世界杯首次使用红黄牌制度。起因是1966年英格兰对阿根廷比赛中，裁判听不懂球员语言无法警告，阿斯顿提议用颜色卡片解决沟通问题。', icon: '🟨', category: 'rules' },
  { title: '越位规则不断收紧', fact: '1990年世界杯后，越位规则修改为"与倒数第二名防守球员平线不算越位"，进球数从此前的场均2.21球上升到2.71球。2022年又引入半自动越位技术，判罚精确到毫米级。', icon: '📏', category: 'rules' },
  { title: '点球大战的诞生', fact: '1978年世界杯首次引入点球大战规则。此前淘汰赛平局需择日重赛，1974年以前甚至靠抽签或掷硬币决定胜负。', icon: '🎯', category: 'rules' },

  // ═══ 奇人异事 (6条) ═══
  { title: '决赛帽子戏法', fact: '1966年英格兰的赫斯特在决赛中上演帽子戏法，至今仍是唯一在世界杯决赛中做到这一点的球员。他的第三球是否越过门线，至今仍有争议。', icon: '🎩', category: 'quirky' },
  { title: '光脚进球的传奇', fact: '1938年世界杯，巴西球员莱昂尼达斯在比赛中鞋子被踩掉，他索性光脚射门得分。这可能是世界杯历史上最随性的进球。', icon: '🦶', category: 'quirky' },
  { title: '齐达内的最后一撞', fact: '2006年决赛，齐达内用头顶撞马特拉齐被红牌罚下，以最戏剧性的方式告别职业生涯。他走过大力神杯时的背影，成为世界杯最具标志性的画面之一。', icon: '😤', category: 'quirky' },
  { title: '苏亚雷斯的手球救险', fact: '2010年四分之一决赛，乌拉圭的苏亚雷斯在门线上用手拍出加纳的必进球被红牌罚下，但吉安罚失点球，乌拉圭最终点球晋级。被称为"魔鬼之手"。', icon: '✋', category: 'quirky' },
  { title: '罗纳尔多的神秘病倒', fact: '1998年决赛前数小时，罗纳尔多突然抽搐倒地，被紧急送医后仍坚持上场，但状态全无，巴西0:3惨败。这场离奇事件至今众说纷纭，成为世界杯最大谜团。', icon: '❓', category: 'quirky' },
  { title: '卡福的球衣号码乌龙', fact: '1994年世界杯决赛，巴西替补卡福在场边准备换上时，发现自己的球衣没有号码。工作人员临时用胶带贴上号码2号，卡福就这样穿着"胶带球衣"完成了世界杯首秀。', icon: '👕', category: 'quirky' },

  // ═══ 数据之最 (6条) ═══
  { title: '红牌最多一届', fact: '2006年德国世界杯共出示28张红牌，是历史上红牌最多的一届，被称为"红牌世界杯"。其中葡萄牙对荷兰的"纽伦堡之战"单场就出了4红16黄。', icon: '🟥', category: 'records' },
  { title: '点球大战之王', fact: '德国队在世界杯点球大战中4战4胜，是点球大战胜率100%的球队。英格兰则3战1胜2负，被称为"点球魔咒"的受害者。', icon: '🎯', category: 'records' },
  { title: '卫冕冠军魔咒', fact: '2002年法国、2010年意大利、2014年西班牙、2018年德国——近20年4支卫冕冠军全部小组出局。只有2006年的巴西打破了这一魔咒（八强出局，至少没小组回家）。', icon: '🔮', category: 'records' },
  { title: '最远进球', fact: '2010年南非世界杯，西班牙的比利亚在对阵智利时从中圈附近射门得分，距离约45米。但历史上最远进球可能是1966年马丁·彼得斯的60码远射。', icon: '🚀', category: 'records' },
  { title: '单场最大比分', fact: '1982年世界杯，匈牙利10:1大胜萨尔瓦多，这是世界杯决赛圈最大比分胜利。但预选赛更夸张——2001年澳大利亚31:0击败美属萨摩亚。', icon: '📈', category: 'records' },
  { title: '最快红牌', fact: '1986年世界杯，乌拉圭的巴蒂斯塔在对苏格兰的比赛中开场仅56秒就被红牌罚下，创下世界杯最快红牌纪录。比赛刚开始，就已经结束了。', icon: '⏱️', category: 'records' },

  // ═══ 文化趣闻 (6条) ═══
  { title: '东道主魔咒', fact: '2010年南非是第一个小组未出线的东道主。此前所有东道主都至少进入了淘汰赛阶段。2022年卡塔尔也未能幸免，成为第二个小组出局的东道主。', icon: '🏠', category: 'culture' },
  { title: '足球战争', fact: '1969年，萨尔瓦多和洪都拉斯因世界杯预选赛争议引发武装冲突，史称"足球战争"。虽然根本原因是土地和移民问题，但足球成为了导火索。', icon: '⚔️', category: 'culture' },
  { title: '呜呜祖拉响彻全球', fact: '2010年南非世界杯，看台上的呜呜祖拉（Vuvuzela）发出持续嗡嗡声，电视转播收到的投诉如潮水般涌来。这种塑料喇叭的音量高达127分贝，堪比喷气式飞机起飞。', icon: '📯', category: 'culture' },
  { title: '马拉卡纳惨案的文化创伤', fact: '1950年巴西主场1:2被乌拉圭逆转后，巴西全国陷入沉默。有球迷当场心脏病发作，有人跳楼自杀。巴西甚至为此创造了专属词汇"Maracanazo"，意为不可承受的失败。', icon: '💔', category: 'culture' },
  { title: '朝鲜队的神秘之旅', fact: '1966年朝鲜队闯入八强，1:0淘汰意大利震惊世界。赛后朝鲜球员在英格兰米德尔斯伯恩受到当地人热情款待，这段故事后来被拍成纪录片《人生的比赛》。', icon: '🇰🇵', category: 'culture' },
  { title: '世界杯与停战', fact: '2006年世界杯期间，科特迪瓦内战双方因国家队闯入决赛圈而宣布停火，球员德罗巴在更衣室跪求和平的视频传遍全球。足球有时真的能阻止战争。', icon: '🕊️', category: 'culture' },
];
